...
class PassengerListOngoing extends StatefulWidget {
  const PassengerListOngoing({Key key}) : super(key: key);

  @override
  _PassengerListOngoingState createState() => _PassengerListOngoingState();
}

class _PassengerListOngoingState extends State<PassengerListOngoing> {
  String discountID;
  String ticketID;
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        onPressed: () async {
                          db.updateAllTripsTravelStatusEndTrip();
                          db.updateCompanyTripsTravelStatusEndTrip();
                          db.updateAllBookingFormsBookingStatusDone();
                          db.updateCompanyBookingFormsBookingStatusDone();
                          db.updateAllBookingFormsBookingStatusAbsent();
                          db.updateCompanyBookingFormsBookingStatusAbsent();
                          Navigator.of(context).pop();
