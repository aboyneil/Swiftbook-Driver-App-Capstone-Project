...
import 'package:swiftbook/passengerList_ongoing.dart';
...
class OngoingTrips extends StatefulWidget {
  const OngoingTrips({Key key}) : super(key: key);

  @override
  _OngoingTripsState createState() => _OngoingTripsState();
}
            ...
            children: <Widget>[
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('Travel Status', isEqualTo: 'Ongoing')
                    .where('Trip Status', isEqualTo: true)
                    .where("Departure Date", isGreaterThanOrEqualTo: dateNowFormatted + ' 00:00:00')
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              data['Bus Class']
                                                  .toString().toLowerCase().titleCase,
